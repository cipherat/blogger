...
from fastapi import APIRouter, UploadFile, File, Depends, Request, HTTPException, status, Query
...
@router.get("/", name="get_page_blogs", response_model=GetPageBlogsResponse, status_code=status.HTTP_200_OK)
